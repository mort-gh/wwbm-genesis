...
// actions
import { saveScore, nextQuestionHandler, disableButtons, getNextQuestionData } from '../redux/Game.actions';
...
const mapDispatchToProps = (dispatch) => ({
   ...
   getNextQuestionData: (num) => dispatch(getNextQuestionData(num)),
});
